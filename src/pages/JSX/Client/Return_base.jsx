...
const updateStatus = (serial, newStatus) => {
  ...
  return (
    <div className="returnbase-container">
      ...
      <div className="returnbase-header">
        ...
        <button className="returnbase-add-btn" onClick={() => setShowForm(true)}>
          <FaPlus /> New Request
        </button>
      </div>
 ...
 <div className="returnbase-cards">
  ...
  <img src={returnImg} alt="Drone" className="returnbase-card-icon" />
  <h3>{req.model}</h3>
</div>

          <span className={`returnbase-status-badge ${req.status.toLowerCase()}`}>
            {req.status}
          </span>
        </div>
        ...
        <div className="returnbase-card-body">
          ...
          <p><strong>Serial No:</strong> {req.serial}</p>
          <p><strong>Reported By:</strong> {req.reportedBy}</p>
        </div>
        ...
        <div className="returnbase-popup-overlay">
          <div className="returnbase-popup">
            <div className="returnbase-popup-header">
              ...
              <button className="returnbase-close-btn" onClick={() => setShowForm(false)}>
                ✕
              </button>
            </div>
